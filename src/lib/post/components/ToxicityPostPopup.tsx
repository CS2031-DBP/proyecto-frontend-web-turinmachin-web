...
export const VerificationPopup = ({ onClose }: Props) => (
  <div className="bg-surface border-background-alt relative w-full max-w-sm rounded-xl border px-6 py-8">
    ...
    <p>
      Hemos detectado que tu publicación podría contener contenido no seguro.
      Por favor, revisa y ajusta el mensaje antes de intentarlo nuevamente.
      ¡Gracias por ayudarnos a mantener un espacio seguro para todos!
    </p>
    <button
      onClick={onClose}
